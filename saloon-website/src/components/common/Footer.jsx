          ...
          <div className="footer-grid">
            ...
            <div className="footer-brand">
              ...
              <p className="footer-tagline">
                Where elegance meets expert care. Experience world-class beauty
                and grooming services in Bhubaneswar's premier luxury salon.
              </p>
              ...
              <div className="footer-social">
                ...
                <a href="https://wa.me/919337720521" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="WhatsApp">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="footer-section">
              ...
              <nav className="footer-links">
                ...
                <Link to="/services">Skin & Spa</Link>
                <Link to="/services">Bridal Makeup</Link>
                <Link to="/services">Men's Grooming</Link>
            ...
            <div className="footer-section">
              ...
              <div className="footer-contact">
                ...
                <div className="contact-item">
                  ...
                  <a href="tel:+919337720521">+91 93377 20521</a>
                </div>
                <div className="contact-item">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="container">
          <div className="footer-bottom-content">
            <p className="copyright">
              © {currentYear} Minjal Salon. All rights reserved.
            </p>
